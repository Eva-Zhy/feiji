...
var bullet_sizeX = 15;
var bullet_sizeY = 15;
var bullet_src = "image/zidan.png";
...
function ourplan(X,Y){
    var imagesrc="image/myfeiji1.png";
    // hp,a,b,sizeX,sizeY,score,dietime,sudu,boomimage,imagesrc
    plan.call(this,1,X,Y,78,147,0,660,0,"image/myfeiji1.png",imagesrc);
...
var dW=$('body').width();;
var dH = $('body').height();
var selfplan=new ourplan(dW/2-33,dH*0.75-30);
//移动事件
...
function start(){
    ...
    if(mark==20){
        ...
        //中飞机
        if(mark1%5==0){
            enemys.push(new enemy(6+xueliang,25,274,70,59,1,360,random(1,3),"image/feiji1_boom.png","image/feiji1.png"));
        }
        //大飞机
        if(mark1==20){
            enemys.push(new enemy(12+xueliang,57,210,70,51,1,540,1,"image/feiji2_boom.png","image/feiji2.png"));
            mark1=0;
        }
        //小飞机
        else{
            enemys.push(new enemy(1+xueliang,19,286,80,70,1,360,random(1,4),"image/feiji3_boom.png","image/feiji3.png"));
        }
...
*/
    if(mark%5==0){
            bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+bullet_left,parseInt(selfplan.imagenode.style.top)-10));
    }
